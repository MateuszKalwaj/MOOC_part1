...
public class NhlStatisticsPart2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("NHL sclubtatistics service");
        ...
        while (true) {
            ...
            //  Print the top ten players sorted by assists.
                ...
                System.out.println("Which player statistic you want to see?");
                String userInput = reader.nextLine();
                NHLStatistics.searchByPlayer(userInput);

                // Ask the user first which player's statistics are needed and then print them.
            } else if (command.equals("club")) {
                System.out.print("'Which club do you want to see?");
                String userInput = reader.nextLine();
                NHLStatistics.sortByPoints();
                NHLStatistics.teamStatistics(userInput);
